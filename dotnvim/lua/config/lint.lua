...
nvim_lint.linters.revive.args = {'-config', '/Users/jennings.leavitt/Projects/neo/config.toml'}
...
local function enable_lint()
    ...
    if vim.bo.filetype ~= "" then print("JENNINGS: the filetype check for nvim-lint is working now") end
